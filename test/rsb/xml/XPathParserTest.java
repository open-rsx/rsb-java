...
public class XPathParserTest {
	...
	/**
	 * Test method for
	 * {@link net.sf.xcf.xml.XPathParser#XPathParser(java.lang.String)}.
	 */
	@Ignore
	@Test
	 ...
	 */
	@Test
	public void testToXPathExpression() throws XPathNotSupportedException {
		...
		xpath = parser.toXPathExpression();
		assertEquals("/element[@dbxml:id=\"1\" and @attribute=\"test\"]",
				xpath.getExpression());

		parser = new XPathParser(
				"/element-name[@attribute=\"test\"]/one[@test]", 1);
		xpath = parser.toXPathExpression();
		assertEquals(
				"/element-name[@dbxml:id=\"1\" and @attribute=\"test\"]/one[@test]",
				xpath.getExpression());
		...
		xpath = parser.toXPathExpression();
		assertEquals("/element-name[@dbxml:id=\"1\" and @attribute=\"test\"]",
				xpath.getExpression());
		// TODO think about not yet supported xpaths

...
/**
 *
 * SpreadMessageConverter encapsulates the handling of regular spread messages and 
 * considers Membership messages. 
 * 
...
class SpreadMessageConverter {
	...
	public DataMessage process(SpreadMessage sm) {
		...
		if (sm.isMembership()) {
			...
			log.info("Received membership message for group: " + sm.getMembershipInfo().getGroup());

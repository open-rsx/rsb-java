...
public class LoggingObserver implements ParticipantObserver {
    ...
    @Override
    public void created(final Participant participant, final ParticipantCreateArgs<?> args) {
        LOG.info("New participant created: " + participant.getId() + " at " + participant.getScope() + " with parent: " + args.getParent());
    }

    @Override
    public void destroyed(final Participant participant) {
        LOG.info("Participant removed: " + participant.getId() + " at " + participant.getScope());
    }
